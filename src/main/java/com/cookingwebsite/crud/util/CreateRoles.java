...
/**
 * VERY IMPORTANT: THIS CLASS WILL ONLY BE EXECUTED ONCE TO CREATE THE ROLES. 
 * ONCE CREATED, THE CODE MUST BE DELETED OR COMMENTED OUT.
 * THEY CAN BE LOADED FROM THE INITIAL SCRIPT TO GENERATE THE TABLES WITH DOCKER.
 *
 */
...
public class CreateRoles implements CommandLineRunner {
    ...
    private void checkRoleExistenceAndIfNotExistCreate(final RoleName roleName) {
    	...
    	try {
    		optionalRole = roleService.getByRoleName(roleName);
    	} catch (Exception e) {
